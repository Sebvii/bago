...
public class FoodOneFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_one_fragment);  // Set the layout for the activity
        ...
        captureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent captureIntent = new Intent(FoodOneFragment.this, FoodOneFragment.class);  // Change to the correct activity
