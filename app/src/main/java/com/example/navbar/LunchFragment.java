...
public class LunchFragment extends AppCompatActivity {  // Fixed potential typo in class name
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_fragment);  // Ensure this matches your XML file name
