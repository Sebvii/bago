...
public class SnacksFragment extends AppCompatActivity {  // Fixed potential typo in class name
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snacks_fragment);  // Ensure this matches your XML file name
